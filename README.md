<!--  root@iusearchbtw:~# cat README.md  -->
...
```
root@iusearchbtw:~# cat /etc/identity
```
...
herd:        100 sheep               # 100 nodes in the botnet 🐑 baa.
trolling:    for fun & profit        # since forever
threat:      👁️  always watching
```
